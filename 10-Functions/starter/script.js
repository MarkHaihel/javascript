...
const createBooking = function (
  flightNumber,
  numberPassangers = 1,
  price = 199 * numberPassangers
) {
  // ES5
  // numberPassangers = numberPassangers || 1;
  // price = price || 199;
...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.password === 223854385) {
    alert('Check in');
  } else {
...
['Mark', 'Martha', 'Adam'].forEach(high5);
*/
...
lufthansa.book(239, 'Mark Haihel');
