...
console.log('Mark Haihel'.split(' '));

const [firstName, lastName] = 'Mark Haihel'.split(' ');
...
console.log(maskCredit(4242424242424242));
console.log(maskCredit('4325234352453422'));
...
const capitalizationOfString = function (str) {
  const strLower = str.toLowerCase();
  return strLower[0].toUpperCase() + strLower.slice(1);
};
console.log(capitalizationOfString(passenger));
...
console.log(typeof new String('mark'));

console.log(typeof new String('mark').slice(1));
*/
...
console.log(new Set('markhaihel').size);
*/
...
let avarage = 0;
for (const odd in odds) avarage += odd;
avarage /= odds.length;
console.log(avarage);
...
// Arrays
const users = [{ name: 'Mark', email: 'hello@mark.io' }];
// const users = [];
...
console.log('Hello' && 23 && null && 'Mark');
