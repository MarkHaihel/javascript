...
const mark = new Person('Mark', 1999);
console.log(mark);
...
console.log(mark.species, matilda.species);
...
const arr = [3, 5, 4, 2, 6, 7, 5, 2, 3, 4];
console.log(arr.__proto__);
console.log(arr.__proto__ === Array.prototype);

console.log(arr.__proto__.__proto__);

// Don't do this (new ES release can contain methods with same name and rewrite logic,
// or other developers can do this with different name)
...
const merc = new Car('Mercedes', 120);
...
const tesla = new EV('Test', 120, 23);
...
class Account {
  ...
  constructor(owner, currency, pin) {
    ...
    console.log(`Tanks for opening an account, ${owner}`);
  }
...
const acc1 = new Account('Mark', 'EUR', 1111);
console.log(acc1);
